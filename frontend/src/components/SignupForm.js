...
const SignUp = () => {
    ...
    const handleSignUp = async (e) => {
        ...
        try {
            const response = await fetch('http://localhost:5000/api/register', { // Ensure the correct server address
                method: 'POST',
                headers: {
        ...
        <div className="signup-form flex justify-center items-center min-h-screen bg-gradient-to-b from-black via-gray-900 to-green-900">
            <div className="bg-gray-800 bg-opacity-50 p-8 rounded-lg text-center text-white max-w-md w-full">
                ...
                <div className="mt-6 flex justify-center gap-4 items-center">
                    ...
                    <button onClick={handleGoogleLogin} className="p-2 rounded bg-white hover:bg-gray-200 text-black w-12 h-12 flex items-center justify-center">
                    ...
                    <button onClick={handleFacebookLogin} className="p-2 rounded bg-white hover:bg-gray-200 text-black w-12 h-12 flex items-center justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" className="w-6 h-6">
